...
if __name__ == '__main__':
    ...
    got10k_path = '/data_B/dataset_GOT10k/GOT-10k'
    save_path = '/data_B/renjie/CSA/pysot/testing_dataset/GOT10K_reproduce'
    ...
    for i ,video in enumerate(video_list):
        ...
        frames_list = [frame for frame in frames_list if pattern.match(os.path.basename(frame))]
